...
public class ResumeController {
    ...
    public ResultPaginationDTO getAllResumes(@Filter Specification<Resume> spec, Pageable pageable) {
        return this.resumeService.handleGetAllResumes(spec, pageable);
    }
}
